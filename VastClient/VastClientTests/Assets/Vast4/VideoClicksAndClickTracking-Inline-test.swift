...
extension VastModel {
    static let videoClicksAndClickTrackingInline: VastModel = {
        ...
        let categories: [VastAdCategory] = [
            VastAdCategory(authority: URL(string: "http://www.iabtechlab.com/categoryauthority"), category: "AD CONTENT description category")
        ]
        
        let videoClicks: [VastVideoClick] = [
            VastVideoClick(id: nil, type: .clickTracking, url: URL(string: "http://myTrackingURL/clickTracking")),
        ...
        let ad = VastAd(type: .inline, id: "20009", sequence: 1, conditionalAd: false, adSystem: adSystem, impressions: [impressions], adVerifications: [], viewableImpression: nil, pricing: pricing, errors: errors, creatives: [creative], extensions: extensions, adTitle: "iabtechlab video ad", wrapperUrl: nil, adCategories: categories, description: nil, advertiser: nil, surveys: [], wrapper: nil)
