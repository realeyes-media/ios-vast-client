...
enum VatMacros: String {
    ...
    case timestapm = "[TIMESTAMP]" //date and time at which the URI using this macro is accessed using ISO 8601 with miliseconds: January 17, 2016 at 8:15:07 and 127 milleseconds, Eastern Time would be formatted as follows: 2016-01-17T8:15:07.127-05
}
