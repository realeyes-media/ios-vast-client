...
extension VastModel {
    static let wrapperTag3: VastModel = {
        ...
        let ad = VastAd(type: .wrapper, id: "20011", sequence: 0, conditionalAd: nil, adSystem: adSystem, impressions: impressions, adVerifications: [], viewableImpression: nil, pricing: nil, errors: errors, creatives: [creative], extensions: extensions, adTitle: nil, wrapperUrl: nil, adCategories: [], description: nil, advertiser: nil, surveys: [], wrapper: wrapper)
