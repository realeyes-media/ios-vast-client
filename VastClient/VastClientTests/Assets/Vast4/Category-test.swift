...
extension VastModel {
    static let category: VastModel = {
        ...
        let categories: [VastAdCategory] = [
            VastAdCategory(authority: URL(string: "http://www.iabtechlab.com/categoryauthority"), category: "American Cuisine"),
            VastAdCategory(authority: URL(string: "http://www.iabtechlab.com/categoryauthority"), category: "Guitar"),
            VastAdCategory(authority: URL(string: "http://www.iabtechlab.com/categoryauthority"), category: "Vegan")
        ]
        ...
        let trackingEvents: [VastTrackingEvent] = [
            VastTrackingEvent(type: .start, offset: 30841, url: URL(string: "http://example.com/tracking/start"), tracked: false),
        ...
        let ad = VastAd(type: .inline, id: "20008", sequence: 1, conditionalAd: false, adSystem: adSystem, impressions: [impressions], adVerifications: [], viewableImpression: nil, pricing: pricing, errors: errors, creatives: [creative], extensions: extensions, adTitle: "iabtechlab video ad", wrapperUrl: nil, adCategories: categories, description: nil, advertiser: nil, surveys: [], wrapper: nil)
