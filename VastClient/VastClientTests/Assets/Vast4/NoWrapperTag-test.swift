...
extension VastModel {
    static let noWrapperTag: VastModel = {
        ...
        let trackingEvents: [VastTrackingEvent] = [
            VastTrackingEvent(type: .start, offset: 34490, url: URL(string: "http://example.com/tracking/start"), tracked: false),
