...
extension VastModel {
    static let adVerification: VastModel = {
        ...
        let categories: [VastAdCategory] = [
            VastAdCategory(authority: URL(string: "http://foo"), category: nil)
        ]
        ...
        let trackingEvents: [VastTrackingEvent] = [
            VastTrackingEvent(type: .start, offset: 44531, url: URL(string: "http://example.com/tracking/start"), tracked: false),
