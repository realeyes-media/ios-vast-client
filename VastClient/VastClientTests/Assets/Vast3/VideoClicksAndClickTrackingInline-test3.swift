//
//  VideoClicksAndClickTrackingInline-test.swift
//  Vaster_Tests
//
...
extension VastModel {
    static let videoClicksAndClickTrackingInLine3: VastModel = {
        ...
        let videoClicks: [VastVideoClick] = [
            ...
            VastVideoClick(id: nil, type: .clickTracking, url: URL(string: "http://example.com/trackingurl/clickTracking"))
        ]
        let trackingEvents: [VastTrackingEvent] = [
            VastTrackingEvent(type: .start, offset: 35123, url: URL(string: "http://example.com/tracking/start"), tracked: false),
        ...
        let mediaFiles: [VastMediaFile] = [
            VastMediaFile(delivery: "progressive", type: "video/mp4", width: "400", height: "300", codec: "0", id: "5241", bitrate: 500, minBitrate: 360, maxBitrate: 1080, scalable: true, maintainAspectRatio: true, apiFramework: nil, url: URL(string: "https://iabtechlab.com/wp-content/uploads/2016/07/VAST-4.0-Short-Intro.mp4"))
        ]
        ...
        let ad = VastAd(type: .inline, id: "20009", sequence: 0, conditionalAd: nil, adSystem: adSystem, impressions: [impressions], adVerifications: [], viewableImpression: nil, pricing: pricing, errors: errors, creatives: [creative], extensions: extensions, adTitle: adTitle, wrapperUrl: nil, adCategories: [], description: nil, advertiser: nil, surveys: [], wrapper: nil)
