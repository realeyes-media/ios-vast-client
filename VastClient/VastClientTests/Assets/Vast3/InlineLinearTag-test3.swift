...
extension VastModel {
    static let inlineLinearTag3: VastModel = {
        ...
        let videoClicks: [VastVideoClick] = [
            VastVideoClick(id: "blog", type: .clickTracking, url: URL(string: "https://iabtechlab.com")),
            VastVideoClick(id: nil, type: .customClick, url: URL(string: "http://iabtechlab.com"))
        ]
